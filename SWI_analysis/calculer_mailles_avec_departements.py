...
def calculer_mailles_avec_departements():
    ...
    gdf_result.drop(columns=['index_right','geometry']).to_csv(BDD_MAILLES_AVEC_DEPARTEMENTS_PATH, index=False, sep=';')
    df_departements.to_csv(BDD_DEPARTEMENTS_PATH, index=False, sep=';')
